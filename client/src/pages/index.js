		...
		<main className="w-full space-y-4">
			...
			<section className="px-10 py-4">
				...
				<div className="flex flex-col space-x-0 space-y-2 sm:space-y-0 sm:flex-row sm:space-x-2">
					<Link
						href="/syllabus"
						className="flex flex-col items-center justify-center h-20 px-8 font-bold duration-150 border-2 border-black rounded-sm hover:bg-neutral-200 dark:hover:bg-neutral-800 dark:border-white"
					>
						<FeatherIcon size={30} />
						<span>Syllabus</span>
					</Link>
